...
import nextauth from "../../public/nextauth.webp"
import zustand from "../../public/zustand.webp"
import zodlogo from "../../public/zodlogo.svg"
...
const Expr = () => {
  return (
    <div
      id="experience"
      className="w-full group select-none mt-10  flex justify-center items-center gap-5 flex-wrap  bg-pr1/30 rounded-lg  p-10 backdrop-blur-2xl shadow-lg shadow-pr2/30 hover:shadow-sm duration-500 transition-all"
    >
      <h1 className="mb-5 duration-100  text-center font-light text-2xl w-full">
        I have had the opportunity to gain a lot of experience in
      </h1>
      ...
      <div
        title="Typescript"
        className=" flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm shadow-pr2/50 duration-200"
      >
        <svg
      ...
      <div
        title="React Js"
        className="  flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm duration-200 shadow-pr2/50"
      >
      ...
      <div
        ...
        className="flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm duration-200 shadow-pr2/50"
      >
        <Image className="w-10 object-contain" src={astro} alt="" />
      </div>
      ...
      >
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path
            className="fill-cyan-800 dark:fill-cyan-500"
      ...
      >
        ...
        >
          <path
            d="M78.066 92.588c12.818 0 23.209-10.391 23.209-23.21 0-12.817-10.391-23.208-23.21-23.208-12.817 0-23.208 10.39-23.208 23.209 0 12.818 10.391 23.209 23.209 23.209zm-54.857 46.417c12.818 0 23.209-10.39 23.209-23.209 0-12.817-10.391-23.208-23.21-23.208C10.392 92.588 0 102.978 0 115.796c0 12.818 10.39 23.21 23.209 23.21zm209.582 0c12.818 0 23.209-10.39 23.209-23.209 0-12.817-10.39-23.208-23.209-23.208-12.818 0-23.209 10.39-23.209 23.208 0 12.818 10.391 23.21 23.21 23.21z"
            fill="white"
          />
          <path
      ...
      <div
        ...
        className="flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm duration-200 shadow-pr2/50"
      >
        <Image src={zustand} alt="" />
      </div>

      {/* <!--react query--> */}
      <div className="flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm duration-200 shadow-pr2/50">
        <Image src={reactquery} alt="" />
      </div>
      ...
      <div
        ...
        className="flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm duration-200 shadow-pr2/50"
      >
        <svg className="w-14" viewBox="0 0 291 69" fill="none">
          <path
      ...
      <div
        ...
        className="flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm duration-200 shadow-pr2/50"
      >
        <Image src={zodlogo} alt="zod" />
      </div>

      {/* <!-- next auth   --> */}
      <div
        title="Next Auth"
        className="relative flex justify-center items-center w-16 h-16 backdrop-blur-sm  p-1 rounded-lg shadow-lg hover:shadow-sm duration-200 shadow-pr2/50"
      >
        <Image  className="w-10 object-contain" src={nextauth} alt="" />
      </div>
      ...
      >
        <svg viewBox="0 0 101 101" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" fill-rule="evenodd">
            ...
            />
            <path
              d="m57.8 73.3 15.8 21.8 12.1-8.8-15.8-21.8-12.1-3.9v12.7zm-15-46.1L26.9 5.4l-12.1 8.8L30.6 36l12.2 3.9V27.2z"
              fill="#00F2E6"
            />
            <path
              d="M30.6 36 5 27.7.4 41.9 26 50.3l12.1-4L30.6 36zm31.8 18.2 7.5 10.3 25.6 8.3 4.6-14.2-25.6-8.3-12.1 3.9z"
              fill="#00B9F1"
            />
            <path
              d="m74.5 50.3 25.6-8.4-4.6-14.2L69.9 36l-7.5 10.3 12.1 4zm-48.5 0L.4 58.6 5 72.8l25.6-8.3 7.5-10.3L26 50.3z"
              fill="#D63AFF"
            />
            <path
